...
The best way to decide what API to use is to look at the [following section](https://carecloud.readme.io/reference/getting-started-with-your-api#interface).
...
CareCloud APIs use Bearer authentication if resources require it. You can find the complete guide in the [Authentication section](https://carecloud.readme.io/reference/authentication)
...
Customer login is not mandatory in CareCloud APIs for specific resources. If the customer wants to access their personal or purchase data, they must log in. How to do it is described in [the following use case section](https://www.crmcarecloud.com/build-a-mobile-app/).